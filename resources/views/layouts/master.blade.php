...
<!-- Fonts -->
{{-- <script src="{{asset('fonts/Merriweather-Regular.ttf')}}"></script> --}}
{{-- <link href="https://fonts.googleapis.com/css?family=Coda+Caption:800" rel="stylesheet"> --}}
{{-- <link href="{{asset('fonts/Merriweather-Regular.ttf')}}" rel="stylesheet"> --}}

{{-- <link rel="stylesheet" href="{{asset('fonts/merriweather-black.ttf')}}"> --}}
{{-- <link href="{{asset('fonts/Merriweather-Regular.ttf')}}" rel='stylesheet' type='text/css' /> --}}
...
<div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-top" role="navigation">
		  ...
		  <div class="drop-men" id="app">
		        <ul class=" nav_1">

                    <notification-component v-bind:notifications="notifications"> </notification-component>
		    		{{-- <li class="dropdown at-drop">
                                            <a href="#" class="dropdown-toggle dropdown-at " data-toggle="dropdown"><i class="fa fa-bell" aria-hidden="true"><small style="color: black !important;"> 3</small></i></a>
                                        </li> --}}
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level ">
                            <li><a href="{{url('/asilados_registrados')}}" class=" hvr-bounce-to-right"><i class="fa fa-align-left nav_icon"></i>Ancianos</a></li>
                  ...
                  @if(Auth::user()->type=='admin')
                    <li>
                        <a href="{{url('/chart')}}" class=" hvr-bounce-to-right"><i class="fa fa-indent nav_icon"></i> <span class="nav-label">Reportes</span></a>
                        {{-- <ul class="nav nav-second-level"> --}}
                  ...
                  <a href="#" class="dropdown-toggle dropdown-at" data-toggle="dropdown"><span class=" name-caret"><i class="fa fa-sign-in nav_icon"></i>{{ Auth::user()->name}} <i class="caret"></i></span>
